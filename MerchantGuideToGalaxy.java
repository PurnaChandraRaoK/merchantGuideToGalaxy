...
public class MerchantGuideToGalaxy {
	...
	/**
	 * Creating symbol table for parsing roman numeral values to decimal nums: key
	 * value entry to keep track of inputs given goods: key value entry to decode
	 * the message and store the Credit value corresponding to the good stuff.
	 **/
...
//subtracting the decimal value of the roman numeral as it is smaller than it's next one.
	...
	/**
	 * To Decode the message and conclude accordingly. it may be a hidden data entry
	 * to goods. it may be a question whose output is required.
	 **/
...
//getting the part of message to be parsed
	...
	public static void main(String[] args) {
		...
		MerchantGuideToGalaxy guide = new MerchantGuideToGalaxy();
